...
import { MetaData, ParticleEmitter } from './ParticleEmitter.js';
import { Object3DEventMap, Blending, BufferGeometry, Layers, Texture, Material } from 'three';
import { RenderMode } from './VFXBatch.js';
import { BatchedRenderer, VFXBatchSettings } from './BatchedRenderer.js';
import { ThreeMetaData } from './util/ThreeUtil.js';
...
export declare class ParticleSystem implements IParticleSystem {
    ...
    static fromJSON(json: ParticleSystemJSONParameters, meta: ThreeMetaData, dependencies: {
