...
## 🗺️ Roadmap
Not sure in which order, but features that will come in the future are: A lot of feature polishing for easier use, Better UI, AI NPCs who can quest, level etc, many more Assets,  automatic switch to a Mobile UI etc.
